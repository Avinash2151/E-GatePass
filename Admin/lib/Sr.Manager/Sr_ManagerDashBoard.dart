...
class SrManagerDashboardWidget extends StatefulWidget {
  ...
  SrManagerDashboardWidget({
    ...
    @required SecurityCheckRepository securityCheckRepository,
        ...
        super(key: key);
  @override
  _SrManagerDashboardWidgetState createState() =>
      _SrManagerDashboardWidgetState();
}

class _SrManagerDashboardWidgetState extends State<SrManagerDashboardWidget> {
  int _currentPage = 0;
