...
import 'package:keepapp/Security/Widgets/ConferenceForm.dart';
import 'package:keepapp/Security/Widgets/VisitForm.dart';
import 'package:keepapp/utils/Utils.dart';

class SecurityConferenceHomePage extends StatelessWidget {
  final _formKey = GlobalKey<FormState>();

  SecurityCheckConferenceBloc securityCheckBloc;
  ...
  Widget build(BuildContext context) {
    ...
    securityCheckBloc = BlocProvider.of<SecurityCheckConferenceBloc>(context);
    print(_media);
    return Scaffold(
        body: Material(
      child: Center(
  ...
  Widget body(var _media, SecurityCheckConferenceBloc securityCheckBloc,
  ...
  checkEntry(BuildContext context) {
    Utils.docIdConference = visitid.text;
    securityCheckBloc.add(DocIdCheckConference(Utils.docIdConference));
    showAlert(context);
