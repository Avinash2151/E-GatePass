...
Future<bool> updateData(SecurityCheck securityCheck) async {
  String docId = securityCheck.doc_id;
  String updateApi =
      "$VISIT_API$docId?updateMask.fieldPaths=status&updateMask.fieldPaths=entryTime&updateMask.fieldPaths=exitTime";
